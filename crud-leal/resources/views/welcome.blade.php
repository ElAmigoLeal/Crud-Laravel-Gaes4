  ...
  <body>
    <nav>
      <div class="logo">
        ...
        <span class="logo-name">AmigoLeal</span>
      </div>
      <div class="sidebar">
        <div class="logo">
          <i class="bx bx-menu menu-icon"></i>
          ...
          <ul class="lists">
            ...
            <li class="list">
              <a href="/documentos" class="nav-link">
                ...
                <span class="link">Documentos</span>
              </a>
            </li>
            <li class="list">
              <a href="/roles" class="nav-link">
                <i class="bx bx-bell icon"></i>
                <span class="link">Roles</span>
              </a>
            </li>
            <li class="list">
            ...
            <li class="list">
              <a href="/facturas" class="nav-link">
                ...
                <span class="link">Facturas</span>
              </a>
            </li>
            <li class="list">
              <a href="/carrocompras" class="nav-link">
              <i class="bx bx-folder-open icon"></i>
                <span class="link">Carro compra</span>
              </a>
            </li>
            <li class="list">
              <a href="/inventarios" class="nav-link">
                <i class="bx bx-folder-open icon"></i>
                <span class="link">Inventarios</span>
              </a>
            </li>
            <li class="list">
              <a href="/permisos" class="nav-link">
                <i class="bx bx-folder-open icon"></i>
                <span class="link">Permisos</span>
              </a>
            </li>
            <li class="list">
              <a href="/descuentos" class="nav-link">
                <i class="bx bx-folder-open icon"></i>
                <span class="link">Descuentos</span>
              </a>
            </li>
            <li class="list">
              <a href="/domicilios" class="nav-link">
                <i class="bx bx-folder-open icon"></i>
                <span class="link">Domicilios</span>
              </a>
              <li class="list">
              <a href="/detalledomicilios" class="nav-link">
                <i class="bx bx-folder-open icon"></i>
                <span class="link">Detalle Domicilios</span>
              </a>
            </li>
            <li class="list">
